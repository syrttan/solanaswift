...
export const Footer: FC = () => {
  return (
    <motion.footer
      ...
      className="border-t border-gray-800/50 bg-gray-900/50 backdrop-blur-sm mt-20"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              Next-generation AMM protocol with adaptive fees, built on Solana for 
              lightning-fast swaps and optimal trading conditions.
            </p>
            <div className="flex space-x-4 mt-4">
              <a
                href="https://twitter.com/solanaswift"
              ...
              <a
                href="https://discord.gg/solanaswift"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Pools</a></li>
        ...
        <div className="border-t border-gray-800/50 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 SolanaSwift. Built for Solana Day hackathon.
            </p>
